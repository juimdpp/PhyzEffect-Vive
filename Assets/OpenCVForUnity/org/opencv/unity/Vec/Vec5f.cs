...
namespace OpenCVForUnity.UnityUtils
{
    ...
    public struct Vec5f : IComparable, IComparable<Vec5f>, IEquatable<Vec5f>, IStructuralComparable, IStructuralEquatable
    {
        ...
        // Implicit conversion to ValueTuple<float, float, float, float, float>
        public static implicit operator (float, float, float, float, float)(in Vec5f vec)
        {
            return (vec.Item1, vec.Item2, vec.Item3, vec.Item4, vec.Item5);
        }

        // Implicit conversion from ValueTuple<float, float, float, float, float>
        public static implicit operator Vec5f(in (float, float, float, float, float) valueTuple)
        {
