...
namespace OpenCVForUnity.UnityUtils
{
    ...
    public struct Vec2b : IComparable, IComparable<Vec2b>, IEquatable<Vec2b>, IStructuralComparable, IStructuralEquatable
    {
        ...
        // Implicit conversion to ValueTuple<byte, byte>
        public static implicit operator (byte, byte)(in Vec2b vec)
        {
            return (vec.Item1, vec.Item2);
        }

        // Implicit conversion from ValueTuple<byte, byte>
        public static implicit operator Vec2b(in (byte, byte) valueTuple)
        {
