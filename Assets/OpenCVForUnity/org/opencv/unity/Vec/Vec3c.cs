...
namespace OpenCVForUnity.UnityUtils
{
    ...
    public struct Vec3c : IComparable, IComparable<Vec3c>, IEquatable<Vec3c>, IStructuralComparable, IStructuralEquatable
    {
        ...
        // Implicit conversion to ValueTuple<sbyte, sbyte, sbyte>
        public static implicit operator (sbyte, sbyte, sbyte)(in Vec3c vec)
        {
            return (vec.Item1, vec.Item2, vec.Item3);
        }

        // Implicit conversion from ValueTuple<sbyte, sbyte, sbyte>
        public static implicit operator Vec3c(in (sbyte, sbyte, sbyte) valueTuple)
        {
