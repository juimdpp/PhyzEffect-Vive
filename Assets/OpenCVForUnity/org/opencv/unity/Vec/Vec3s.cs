...
namespace OpenCVForUnity.UnityUtils
{
    ...
    public struct Vec3s : IComparable, IComparable<Vec3s>, IEquatable<Vec3s>, IStructuralComparable, IStructuralEquatable
    {
        ...
        // Implicit conversion to ValueTuple<short, short, short>
        public static implicit operator (short, short, short)(in Vec3s vec)
        {
            return (vec.Item1, vec.Item2, vec.Item3);
        }

        // Implicit conversion from ValueTuple<short, short, short>
        public static implicit operator Vec3s(in (short, short, short) valueTuple)
        {
