...
namespace OpenCVForUnity.UnityUtils
{
    ...
    public struct Vec4s : IComparable, IComparable<Vec4s>, IEquatable<Vec4s>, IStructuralComparable, IStructuralEquatable
    {
        ...
        // Implicit conversion to ValueTuple<short, short, short, short>
        public static implicit operator (short, short, short, short)(in Vec4s vec)
        {
            return (vec.Item1, vec.Item2, vec.Item3, vec.Item4);
        }

        // Implicit conversion from ValueTuple<short, short, short, short>
        public static implicit operator Vec4s(in (short, short, short, short) valueTuple)
        {
