...
namespace OpenCVForUnity.UnityUtils
{
    ...
    public struct Vec2c : IComparable, IComparable<Vec2c>, IEquatable<Vec2c>, IStructuralComparable, IStructuralEquatable
    {
        ...
        // Implicit conversion to ValueTuple<sbyte, sbyte>
        public static implicit operator (sbyte, sbyte)(in Vec2c vec)
        {
            return (vec.Item1, vec.Item2);
        }

        // Implicit conversion from ValueTuple<sbyte, sbyte>
        public static implicit operator Vec2c(in (sbyte, sbyte) valueTuple)
        {
