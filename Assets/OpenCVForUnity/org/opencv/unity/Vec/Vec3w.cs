...
namespace OpenCVForUnity.UnityUtils
{
    ...
    public struct Vec3w : IComparable, IComparable<Vec3w>, IEquatable<Vec3w>, IStructuralComparable, IStructuralEquatable
    {
        ...
        // Implicit conversion to ValueTuple<ushort, ushort, ushort>
        public static implicit operator (ushort, ushort, ushort)(in Vec3w vec)
        {
            return (vec.Item1, vec.Item2, vec.Item3);
        }

        // Implicit conversion from ValueTuple<ushort, ushort, ushort>
        public static implicit operator Vec3w(in (ushort, ushort, ushort) valueTuple)
        {
