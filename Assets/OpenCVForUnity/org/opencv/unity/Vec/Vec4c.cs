...
namespace OpenCVForUnity.UnityUtils
{
    ...
    public struct Vec4c : IComparable, IComparable<Vec4c>, IEquatable<Vec4c>, IStructuralComparable, IStructuralEquatable
    {
        ...
        // Implicit conversion to ValueTuple<sbyte, sbyte, sbyte, sbyte>
        public static implicit operator (sbyte, sbyte, sbyte, sbyte)(in Vec4c vec)
        {
            return (vec.Item1, vec.Item2, vec.Item3, vec.Item4);
        }

        // Implicit conversion from ValueTuple<sbyte, sbyte, sbyte, sbyte>
        public static implicit operator Vec4c(in (sbyte, sbyte, sbyte, sbyte) valueTuple)
        {
