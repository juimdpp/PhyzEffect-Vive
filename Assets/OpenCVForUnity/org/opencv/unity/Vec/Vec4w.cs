...
namespace OpenCVForUnity.UnityUtils
{
    ...
    public struct Vec4w : IComparable, IComparable<Vec4w>, IEquatable<Vec4w>, IStructuralComparable, IStructuralEquatable
    {
        ...
        // Implicit conversion to ValueTuple<ushort, ushort, ushort, ushort>
        public static implicit operator (ushort, ushort, ushort, ushort)(in Vec4w vec)
        {
            return (vec.Item1, vec.Item2, vec.Item3, vec.Item4);
        }

        // Implicit conversion from ValueTuple<ushort, ushort, ushort, ushort>
        public static implicit operator Vec4w(in (ushort, ushort, ushort, ushort) valueTuple)
        {
