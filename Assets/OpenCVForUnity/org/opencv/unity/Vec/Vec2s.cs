...
namespace OpenCVForUnity.UnityUtils
{
    ...
    public struct Vec2s : IComparable, IComparable<Vec2s>, IEquatable<Vec2s>, IStructuralComparable, IStructuralEquatable
    {
        ...
        // Implicit conversion to ValueTuple<short, short>
        public static implicit operator (short, short)(in Vec2s vec)
        {
            return (vec.Item1, vec.Item2);
        }

        // Implicit conversion from ValueTuple<short, short>
        public static implicit operator Vec2s(in (short, short) valueTuple)
        {
