...
namespace OpenCVForUnity.UnityUtils
{
    ...
    public struct Vec3i : IComparable, IComparable<Vec3i>, IEquatable<Vec3i>, IStructuralComparable, IStructuralEquatable
    {
        ...
        // Implicit conversion to ValueTuple<int, int, int>
        public static implicit operator (int, int, int)(in Vec3i vec)
        {
            return (vec.Item1, vec.Item2, vec.Item3);
        }

        // Implicit conversion from ValueTuple<int, int, int>
        public static implicit operator Vec3i(in (int, int, int) valueTuple)
        {
