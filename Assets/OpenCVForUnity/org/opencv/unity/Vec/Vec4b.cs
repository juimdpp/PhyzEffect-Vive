...
namespace OpenCVForUnity.UnityUtils
{
    ...
    public struct Vec4b : IComparable, IComparable<Vec4b>, IEquatable<Vec4b>, IStructuralComparable, IStructuralEquatable
    {
        ...
        // Implicit conversion to ValueTuple<byte, byte, byte, byte>
        public static implicit operator (byte, byte, byte, byte)(in Vec4b vec)
        {
            return (vec.Item1, vec.Item2, vec.Item3, vec.Item4);
        }

        // Implicit conversion from ValueTuple<byte, byte, byte, byte>
        public static implicit operator Vec4b(in (byte, byte, byte, byte) valueTuple)
        {
