...
namespace OpenCVForUnity.UnityUtils
{
    ...
    public struct Vec3f : IComparable, IComparable<Vec3f>, IEquatable<Vec3f>, IStructuralComparable, IStructuralEquatable
    {
        ...
        // Implicit conversion to ValueTuple<float, float, float>
        public static implicit operator (float, float, float)(in Vec3f vec)
        {
            return (vec.Item1, vec.Item2, vec.Item3);
        }

        // Implicit conversion from ValueTuple<float, float, float>
        public static implicit operator Vec3f(in (float, float, float) valueTuple)
        {
