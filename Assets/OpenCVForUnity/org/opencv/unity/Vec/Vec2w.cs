...
namespace OpenCVForUnity.UnityUtils
{
    ...
    public struct Vec2w : IComparable, IComparable<Vec2w>, IEquatable<Vec2w>, IStructuralComparable, IStructuralEquatable
    {
        ...
        // Implicit conversion to ValueTuple<ushort, ushort>
        public static implicit operator (ushort, ushort)(in Vec2w vec)
        {
            return (vec.Item1, vec.Item2);
        }

        // Implicit conversion from ValueTuple<ushort, ushort>
        public static implicit operator Vec2w(in (ushort, ushort) valueTuple)
        {
