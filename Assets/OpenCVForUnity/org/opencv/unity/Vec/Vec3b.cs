...
namespace OpenCVForUnity.UnityUtils
{
    ...
    public struct Vec3b : IComparable, IComparable<Vec3b>, IEquatable<Vec3b>, IStructuralComparable, IStructuralEquatable
    {
        ...
        // Implicit conversion to ValueTuple<byte, byte, byte>
        public static implicit operator (byte, byte, byte)(in Vec3b vec)
        {
            return (vec.Item1, vec.Item2, vec.Item3);
        }

        // Implicit conversion from ValueTuple<byte, byte, byte>
        public static implicit operator Vec3b(in (byte, byte, byte) valueTuple)
        {
